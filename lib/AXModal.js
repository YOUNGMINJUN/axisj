 ...
 * @logs
 ...
 "2016-05-12 coolio: open 메소드에 로딩 문구 확장"
...
var AXModal = Class.create(AXJ, {
    initialize: function (AXJ_super) {
        ...
        this.config.displayLoadingMesage = "페이지를 로딩 중입니다. 잠시만 기다려 주세요.";
	...
	displayLoadingMesage: {String} ["페이지를 로딩 중입니다. 잠시만 기다려 주세요."] - 모달이 오픈될 때 보여질 로딩 문구
    ...
    open: function (http) {
        ...
        if (cfg.displayLoading) {
            ...
            po.push("		<br/><br><span class='blue'>" + this.config.displayLoadingMesage + "</span></div>");
        }
